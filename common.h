...
struct STRCT    // Real in-data stucture's name with her real fielfs names
{
    ...
    float   param3          = 0.00007;    //  ??? период следования зондирующих импульсв БРЛС в пачке ? - c (для относительной адекватности выбран режим работы в догон с применением СЧП 14 кГц !!!!!)
